...
Q_CONSTINIT static const qt_meta_stringdata_CLASSFileManagerENDCLASS_t qt_meta_stringdata_CLASSFileManagerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 10),  // "fileOpened"
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 8),  // "fileName"
        QT_MOC_LITERAL(33, 9),  // "fileSaved"
        QT_MOC_LITERAL(43, 12),  // "fileModified"
        QT_MOC_LITERAL(56, 8),  // "modified"
        QT_MOC_LITERAL(65, 13),  // "errorOccurred"
        QT_MOC_LITERAL(79, 7),  // "message"
        QT_MOC_LITERAL(87, 16),  // "gridStateChanged"
        QT_MOC_LITERAL(104, 8)   // "showGrid"
    },
    "FileManager",
    "fileOpened",
    "",
...
void FileManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->fileModified((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 3: _t->errorOccurred((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 4: _t->gridStateChanged((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (FileManager::*)(const QString & );
            if (_t _q_method = &FileManager::fileSaved; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &FileManager::fileModified; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        ...
        {
            using _t = void (FileManager::*)(bool );
            if (_t _q_method = &FileManager::gridStateChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 1
void FileManager::fileSaved(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void FileManager::fileModified(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 4
void FileManager::gridStateChanged(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
